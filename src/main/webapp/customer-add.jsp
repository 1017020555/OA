...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/cust/add">
...
<tr bgcolor="#FAFAF1">
	<td height="28" colspan=4 align=center>
		&nbsp;
		<a  onclick="document.getElementById('form2').submit();" class="coolbg">保存</a>
