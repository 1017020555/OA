...
<script type="text/javascript">
	$(function () {
		$.ajax({
			url:"${pageContext.request.contextPath}/pro/getAllProName",
			method:"get",
    ...
    function change(cid) {
        $.ajax({
            url:"${pageContext.request.contextPath}/pro/getAllProName2?id="+cid,
            method:"get",
            success:function (msg) {
                $("#comper").val(msg.companyperson);
            }
        });
        $.ajax({
            url:"${pageContext.request.contextPath}/pro/getAllProName3?cid="+cid,
            method:"get",
            success:function (msg) {
                $("#empFk1").val(msg.pname);
            }
        });
    }
</script>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="comname" id="comname" onchange="change(this.value)">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="empFk1" type="text "name="empFk1" readonly="readonly"/>
	</td>
</tr>
<tr >
