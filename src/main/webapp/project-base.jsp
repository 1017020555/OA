...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
    ...
    <script type="text/javascript">
        function insert() {
           window.location.href="${pageContext.request.contextPath}/pro/getAllProName1";
        }
    </script>
</head>
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="insert()" value='添加新项目' />
 </td>
 </tr>
</table>
</td>
...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/pro/sub' method='get'>
