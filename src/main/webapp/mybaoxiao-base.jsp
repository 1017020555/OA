...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/bx/all' method='get'>
			...
			<td background='skin/images/wbg.gif' align='center'>
				<table border='0' cellpadding='0' cellspacing='0'>
					<tr>
						...
						<td width='160'>
							<input type='text' name='search_like_keyword' style='width:120px' />
						</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<c:forEach varStatus="i" items="${page.list}" var="bs">
	<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
		<td><input name="id" type="checkbox" id="id" class="np"></td>
		<td>${i.index+1}</td>
		<td>${bs.totalmoney}</td>
		<td align="center">
			<a href=''>
